...
public class DrillCategoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        drills.add(new Drill(getString(R.string.drill_1_title),getString(R.string.info_drill_1),R.drawable.drill1));
        drills.add(new Drill(getString(R.string.drill_2_title),getString(R.string.info_drill_2),R.drawable.drill2));
        ...
        listViewDrills.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                intent.putExtra("img",drill.getImageResourceId());
